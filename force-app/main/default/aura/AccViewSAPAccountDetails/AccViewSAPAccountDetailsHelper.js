        ...
        action.setCallback(this, function (response) {
            ...
            if (state === "SUCCESS") {
                if(response.getReturnValue){
                    ...
                    if(account){
                        component.set("v.accRcrdTypeName", account.RecordType.Name);

                        if(account.Credit_Last_Updated_Date__c){
                            component.set("v.creditLastUpdateDate", this.convertDateTime(account.Credit_Last_Updated_Date__c));
                        }
