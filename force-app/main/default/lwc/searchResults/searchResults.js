...
export default class SearchResults extends NavigationMixin(LightningElement) {
    ...
    /**
    * Gets the name of product category
    **/
    get categoryName() {
        return this.productCategory.data.fields.Name.value;
    }
    ...
    //               console.log('display wire data:', this.displayData);
    //           }
    //       }
    //   }
        ...
        productSearch({
           ...
           // effectiveAccountId: this.effectiveAccountId
            ...
            .then((result) => {
                ...
                console.log('search result:',JSON.stringify(this.displayData));
    ...
    updateCartInformation() {
        ...
        console.log('acc id: ', this.resolvedEffectiveAccountId);
        getCartSummary({
            communityId: communityId,
            effectiveAccountId: this.resolvedEffectiveAccountId
        })
    ...
    handleCloseCarSelector() {
        this.showCarSelector = false;
    }

    handleCarFilter(event){
        this.showCarSelector = false;

        let filter = event.detail;

        let patternFromFilterValue = filter.Tyre_Size_Front__c;
        let patternInFilterKey = 'NT_Tyre_Size__c:Custom';

        this.template.querySelector('c-search-filter').setFilter(patternInFilterKey, patternFromFilterValue);
    }
